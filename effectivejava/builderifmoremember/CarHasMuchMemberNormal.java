...
public class CarHasMuchMemberNormal {
    ...
    public CarHasMuchMemberNormal(String brand,
        ...
        this(brand, color, lisencePlateNumber);
    }
    public CarHasMuchMemberNormal(String brand, String color, String lisencePlateNumber,
                                  int length) {
        this(brand, color, lisencePlateNumber, length);
    }
    public CarHasMuchMemberNormal(String brand,
                                  String color,
                                  String lisencePlateNumber,
                                  int length,
                                  int width) {
        this(brand, color, lisencePlateNumber, length, width);
    }
    public CarHasMuchMemberNormal(String brand,
                                  String color,
                                  String lisencePlateNumber,
