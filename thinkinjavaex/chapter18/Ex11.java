// thinkinjavaex/chapter18/Ex11.java
import java.util.*;
import java.io.*;
import java.lang.reflect.*;
import thinkinjava.chapter10.controller.*;

class GreenhouseControls2 extends GreenhouseControls {
    class Restart extends Event {
        private Event[] eventList;
        private Restart(long delayTime) { super(delayTime); }
        public void action() {
    ...
    public class Ex11 {
        public static void main(String[] args) {
            GreenhouseControls2 gc = 
                new GreenhouseControls2("GreenhouseControls2.dat");
            try {
                if(args.length == 1)
